...
function wc_add_to_cart_message( $product_id ) {
	...
	//	$added_text = sprintf( __( '&quot;%s&quot; was beautiful added to your cart.', 'woocommerce' ), get_the_title( $product_id ) );
	}

	// Output success messages
	if ( get_option( 'woocommerce_cart_redirect_after_add' ) == 'yes' ) :

		$return_to 	= apply_filters( 'woocommerce_continue_shopping_redirect',home_url());
		...
		//$message 	= sprintf('<a href="%s" class="button wc-forward">%s</a> %s', get_permalink( wc_get_page_id( 'strain' ) ), __( 'View Cart', 'woocommerce' ), $added_text );
